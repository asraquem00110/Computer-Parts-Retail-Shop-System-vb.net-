...
Public Class Stocksinreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CPRSS_v1._0.Stocksinreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStocksinreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Stocksinreport = New Stocksinreport()
        rpt.Site = Me.Site
        Return rpt
    End Function

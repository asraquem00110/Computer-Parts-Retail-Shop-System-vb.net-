...
Public Class Receipts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CPRSS_v1._0.Receipts.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_discountprice() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_originalprice() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReceipts
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Receipts = New Receipts()
        rpt.Site = Me.Site
        Return rpt
    End Function
